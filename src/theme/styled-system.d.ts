...
declare module 'styled-system' {
  ...
  export interface Theme<TLength = TLengthStyledSystem> {
    ...
    space?: ObjectOrArray<Properties['margin']>;
    fontSizes?: ObjectOrArray<Properties['fontSize']>;
    colors?: ObjectOrArray<Properties['color']>;
    fonts?: ObjectOrArray<Properties['fontFamily']>;
    fontWeights?: ObjectOrArray<Properties['fontWeight']>;
    lineHeights?: ObjectOrArray<Properties<TLength>['lineHeight']>;
    letterSpacings?: ObjectOrArray<Properties<TLength>['letterSpacing']>;
    sizes?: ObjectOrArray<Properties<{}>['height'] | Properties<{}>['width']>;
    borders?: ObjectOrArray<Properties<{}>['border']>;
    borderStyles?: ObjectOrArray<Properties<{}>['border']>;
    borderWidths?: ObjectOrArray<Properties<TLength>['borderWidth']>;
    radii?: ObjectOrArray<Properties<TLength>['borderRadius']>;
    shadows?: ObjectOrArray<Properties['boxShadow']>;
    zIndices?: ObjectOrArray<Properties['zIndex']>;
  ...
  export type MarginProps<ThemeType extends Theme = RequiredTheme> = Pick<
  ...
  export type MarginTopProps<ThemeType extends Theme = RequiredTheme> = Pick<
    SpaceProps<ThemeType>,
    'mt' | 'marginTop'
  >;

  export type MarginBottomProps<ThemeType extends Theme = RequiredTheme> = Pick<
    SpaceProps<ThemeType>,
    'mb' | 'marginBottom'
  >;

  export type MarginLeftProps<ThemeType extends Theme = RequiredTheme> = Pick<
    SpaceProps<ThemeType>,
    'ml' | 'marginLeft'
  >;

  export type MarginRightProps<ThemeType extends Theme = RequiredTheme> = Pick<
    SpaceProps<ThemeType>,
    'mr' | 'marginRight'
  >;
  ...
  export type PaddingProps<ThemeType extends Theme = RequiredTheme> = Pick<
    SpaceProps<ThemeType>,
    | 'p'
    | 'padding'
    | 'pt'
  ...
  export type PaddingTopProps<ThemeType extends Theme = RequiredTheme> = Pick<
    SpaceProps<ThemeType>,
    'pt' | 'paddingTop'
  >;

  export type PaddingBottomProps<ThemeType extends Theme = RequiredTheme> = Pick<
    SpaceProps<ThemeType>,
    'pb' | 'paddingBottom'
  >;

  export type PaddingLeftProps<ThemeType extends Theme = RequiredTheme> = Pick<
    SpaceProps<ThemeType>,
    'pl' | 'paddingLeft'
  >;

  export type PaddingRightProps<ThemeType extends Theme = RequiredTheme> = Pick<
    SpaceProps<ThemeType>,
    'pr' | 'paddingRight'
  >;
  ...
  export interface FontFamilyProps<ThemeType extends Theme = RequiredTheme> {
    fontFamily?: ResponsiveValue<Properties['fontFamily'], ThemeType>;
  }
  ...
  export interface TextAlignProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    textAlign?: ResponsiveValue<Properties['textAlign'], ThemeType>;
  }
  ...
  export interface FontStyleProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    fontStyle?: ResponsiveValue<Properties['fontStyle'], ThemeType>;
  }
  ...
  export interface DisplayProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    display?: ResponsiveValue<Properties['display'], ThemeType>;
  }
  ...
  export interface WidthProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['width']
  > {
    /**
  ...
  export interface MaxWidthProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['maxWidth']
  > {
    /**
  ...
  export interface MinWidthProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['minWidth']
  > {
    /**
  ...
  export interface HeightProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['height']
  > {
    /**
  ...
  export interface MaxHeightProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['maxHeight']
  > {
    /**
  ...
  export interface MinHeightProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['minHeight']
  > {
    /**
  ...
  export interface VerticalAlignProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['verticalAlign']
  > {
    /**
  ...
  export interface AlignItemsProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    alignItems?: ResponsiveValue<Properties['alignItems'], ThemeType>;
  }
  ...
  export interface AlignContentProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    alignContent?: ResponsiveValue<Properties['alignContent'], ThemeType>;
  }
  ...
  export interface JustifyItemsProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    justifyItems?: ResponsiveValue<Properties['justifyItems'], ThemeType>;
  }
  ...
  export interface JustifyContentProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    justifyContent?: ResponsiveValue<Properties['justifyContent'], ThemeType>;
  }
  ...
  export interface FlexWrapProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    flexWrap?: ResponsiveValue<Properties['flexWrap'], ThemeType>;
  }
  ...
  export interface FlexBasisProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['flexBasis']
  > {
  ...
  export interface FlexDirectionProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    flexDirection?: ResponsiveValue<Properties['flexDirection'], ThemeType>;
  }
  ...
  export interface FlexProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['flex']
  > {
    /**
  ...
  export interface JustifySelfProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    justifySelf?: ResponsiveValue<Properties['justifySelf'], ThemeType>;
  }
  ...
  export interface AlignSelfProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    alignSelf?: ResponsiveValue<Properties['alignSelf'], ThemeType>;
  }
  ...
  export interface OrderProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    order?: ResponsiveValue<Properties['order'], ThemeType>;
  }
  ...
  export interface FlexGrowProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    flexGrow?: ResponsiveValue<Properties['flexGrow'], ThemeType>;
  }
  ...
  export interface FlexShrinkProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    flexShrink?: ResponsiveValue<Properties['flexShrink'], ThemeType>;
  }
  ...
  export interface GridGapProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['gridGap']
  > {
    /**
  ...
  export interface GridColumnGapProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['gridColumnGap']
  > {
    /**
  ...
  export interface GridRowGapProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['gridRowGap']
  > {
    /**
  ...
  export interface GridColumnProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    gridColumn?: ResponsiveValue<Properties['gridColumn'], ThemeType>;
  }
  ...
  export interface GridRowProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    gridRow?: ResponsiveValue<Properties['gridRow'], ThemeType>;
  }
  ...
  export interface GridAutoFlowProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    gridAutoFlow?: ResponsiveValue<Properties['gridAutoFlow'], ThemeType>;
  }
  ...
  export interface GridAutoColumnsProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['gridAutoColumns']
  > {
    /**
  ...
  export interface GridAutoRowsProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['gridAutoRows']
  > {
    /**
  ...
  export interface GridTemplateColumnsProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['gridTemplateColumns']
  > {
    /**
  ...
  export interface GridTemplateRowsProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['gridTemplateRows']
  > {
    /**
  ...
  export interface GridTemplateAreasProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    gridTemplateAreas?: ResponsiveValue<Properties['gridTemplateAreas'], ThemeType>;
  }
  ...
  export interface GridAreaProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    gridArea?: ResponsiveValue<Properties['gridArea'], ThemeType>;
  }
  ...
  export interface BorderTopProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['borderTop']
  > {
    /**
  ...
  export interface BorderRightProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['borderRight']
  > {
    /**
  ...
  export interface BorderBottomProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['borderBottom']
  > {
    /**
  ...
  export interface BorderLeftProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['borderLeft']
  > {
    /**
  ...
  export interface BorderProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['border']
  >
  ...
  export interface BoxShadowProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    boxShadow?: ResponsiveValue<Properties['boxShadow'] | number, ThemeType>;
  }
  ...
  export interface TextShadowProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    textShadow?: ResponsiveValue<Properties['textShadow'] | number, ThemeType>;
  }
  ...
  export interface OpacityProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    opacity?: ResponsiveValue<Properties['opacity'], ThemeType>;
  }
  ...
  export interface OverflowProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    overflow?: ResponsiveValue<Properties['overflow'], ThemeType>;
    /**
     ...
     */
    overflowX?: ResponsiveValue<Properties['overflowX'], ThemeType>;
    /**
     ...
     */
    overflowY?: ResponsiveValue<Properties['overflowY'], ThemeType>;
  }
  ...
  export interface BackgroundImageProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    backgroundImage?: ResponsiveValue<Properties['backgroundImage'], ThemeType>;
  }
  ...
  export interface BackgroundSizeProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['backgroundSize']
  > {
    /**
  ...
  export interface BackgroundPositionProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['backgroundPosition']
  > {
    /**
  ...
  export interface BackgroundRepeatProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    backgroundRepeat?: ResponsiveValue<Properties['backgroundRepeat'], ThemeType>;
  }
  ...
  export interface BackgroundProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['background']
  >
  ...
  export interface ZIndexProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    zIndex?: ResponsiveValue<Properties['zIndex'], ThemeType>;
  }
  ...
  export interface TopProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['top']
  > {
    /**
  ...
  export interface RightProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['right']
  > {
    /**
  ...
  export interface BottomProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['bottom']
  > {
    /**
  ...
  export interface LeftProps<
    ThemeType extends Theme = RequiredTheme,
    TVal = Properties<TLengthStyledSystem>['left']
  > {
    /**
  ...
  export interface PositionProps<ThemeType extends Theme = RequiredTheme>
     ...
     */
    position?: ResponsiveValue<Properties['position'], ThemeType>;
  }
